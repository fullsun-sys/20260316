...
with col1:
    ...
    # 축 레이블 (오른쪽 x축, 위쪽 y축만 표시)
    ax.text(axis_limit * 0.98, 0.0, 'x', fontsize=14, weight='bold', ha='left', va='center')
    ax.text(0.0, axis_limit * 0.98, 'y', fontsize=14, weight='bold', ha='center', va='bottom')
